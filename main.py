...
def main():
    ...
    if option == '0':
        book_name = str(input(prompt_dict[option + 'a']))
        book_author = str(input(prompt_dict[option + 'b']))
        book_release_year = int(input(prompt_dict[option + 'c']))
        print(Book.create_a_book(book_name, book_author, book_release_year))

    elif option == '1':
        book_name = str(input(prompt_dict[option]))
        book_author = str(input(prompt_dict["0b"]))
        ...
        book_name_or_author = str(input(prompt_dict[option]))
